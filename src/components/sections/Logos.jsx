  ...
  return (
    <section className="bg-gradient-to-top">
      <div className="m-auto max-w-[90rem] px-24 py-28 max-xl:px-16  max-xl:py-24 max-lg:px-8  max-md:px-6 ">
        <p className="text-primary-50 m-auto mb-20 text-center text-xl/loose max-xl:text-lg/8 max-sm:mb-16 ">Organizations powered by <span className="font-bold tracking-tight">NoteFlow</span></p>
