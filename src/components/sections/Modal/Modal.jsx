...
function Modal({children , modal}) {
  ...
  return (
    <motion.div className="fixed top-0 left-0 bottom-0 right-0 z-50 flex items-center justify-center px-24 py-32 backdrop-blur-sm max-lg:px-8 max-md:px-6 "
    ...
    >
      <motion.div className="flex overflow-hidden rounded-2xl opacity-0 shadow-[0px_0px_20px_rgb(6,10,10,.10)]" initial={{opacity:0 , y:40 }}
