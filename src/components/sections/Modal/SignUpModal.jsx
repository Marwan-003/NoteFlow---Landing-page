  ...
  return (
    <section className="grid max-w-3xl grid-cols-2 max-sm:w-96 max-sm:grid-cols-1">
      ...
      <div className="bg-primary-1500 flex flex-col justify-between gap-y-24 bg-[url(.../src/assets/Noise.webp)] bg-repeat p-10 max-md:px-6 max-md:py-8 max-sm:gap-y-16">
        ...
        <div className="text-primary-50 flex flex-col gap-y-6 text-xl/8 font-semibold tracking-tight max-md:font-normal">
          <label>
            Email
            <input
              type="email"
        ...
        <div>
          ...
          >
            <button
              className={`border-primary-100 transition-properties mr-2 inline-flex h-4 w-4 cursor-pointer justify-center rounded-sm border-2 items-center ${checked && "bg-primary-100"}`}
            >
